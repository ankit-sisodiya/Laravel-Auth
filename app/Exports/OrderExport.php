...
class OrderExport implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents, WithMapping{
    ...
    */
    ...
    public function collection(){
        ...
        foreach($orders as $order){
            ...
            'account_types.code as accountType','bank_row_details.branch_name','bank_row_details.sort_code','bank_details.bank_code as BankCode')
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $event->sheet->getStyle($header)->getAlignment()->applyFromArray(array('horizontal' => 'left'));
