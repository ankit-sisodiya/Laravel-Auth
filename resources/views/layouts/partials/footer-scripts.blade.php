        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="text-sm-end d-none d-sm-block">
                    Design & Develop by PHPPOETS IT SOLUTIONS PVT. LTD.
                </div>
            </div>
        </div>
    </div>
    ...
    <!--end back-to-top-->
      ...
      <script src="{{ asset('assets/js/jquery/jquery.min.js')}}"></script>
       ...
       <script src="{{ URL::asset('assets/js/app.js')}}"></script>
        ...
        <script> function filterTogg() { $("#collapseref").toggle() }; 
                ...
                success: function (response) {
                   ...
                   $("#search-dropdown").empty();
                    ...
                    response.data.forEach(element => {
                        ...
                        a.target = '_blank';                        
                        a.setAttribute('class', 'dropdown-item notify-item py-2');  
